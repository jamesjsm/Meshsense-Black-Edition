...
export let autoConnectOnStartup = new State<boolean>('autoConnectOnStartup', false, { persist: 'api' })
export let enableTLS = new State<boolean>('enableTLS', false, { persist: 'api' })
...
export type NodeInfo = {
  ...
  trace?: any
  traceOrigin?: number
  traceReceivedAt?: number
  powerMetrics?: Record<string, number>
