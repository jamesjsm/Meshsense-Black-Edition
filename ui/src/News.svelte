...
<Modal title="Original MeshSense project — Affirmatech news" bind:visible={$newsVisible} fillHeight={true}>
  <div class="flex flex-col h-full gap-4">
    ...
    <div>
      Enjoying MeshSense? Please consider <a
        ...
        href="https://purchase.affirmatech.com/?productId=MeshSenseDonation">supporting the original project</a
      > — the original project's developers. Black Edition is an independent modification.
    </div>
  </div>
</Modal>
