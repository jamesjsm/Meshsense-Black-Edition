...
{#if visible}
  ...
  <div
    ...
    text-sm transition-opacity duration-300 border rounded-lg shadow-sm text-gray-200 border-gray-600 bg-[#313338]"
  >
    <div class="px-3 py-2 border-b rounded-t-lg border-gray-600 bg-[#232428]">
      {#if title != undefined}
